      ...
      >
        ...
        <a-form-item>
          ...
          <div class="memory-actions">
            <a-button type="text" size="small" :disabled="loading" @click="handleClearMemory">
              <template #icon>
                <DeleteOutlined />
              </template>
              清除偏好记忆
...
const handleClearMemory = async () => {
  ...
  try {
    ...
    message.success('偏好记忆已清除')
  } catch (error: any) {
    message.error(error.message || '清除偏好记忆失败')
  }
}
